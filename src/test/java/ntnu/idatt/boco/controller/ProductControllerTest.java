...
public class ProductControllerTest {
    ...
    private final Product TEST_PRODUCT_INVALID = new Product(2, null, "A one-handed melee weapon which requires an Attack level of 70 to wield.", "Gilenor", 300.0, false, LocalDate.of(2022, 2, 1), LocalDate.of(2022, 9, 25), 1, "utstyr");
    // Test images
    ...
    @Test
    @Order(2)
    public void unSuccessfullyRetrievedProductsByUser() {
        assertEquals(500, productController.getUsersProducts(67).getStatusCodeValue());
    }
    ...
    @Test
    @Order(5)
    public void unSuccessfullyRetrievedAllProducts() {
        assertEquals(500, productController.getProductFromSearch(null, null, 1,"notValid", true).getStatusCodeValue());
    }

    @Test
    @Order(6)
    public void unSuccessfullyRegisteredNewProduct() {
        assertEquals(500, productController.newProduct(TEST_PRODUCT_INVALID).getStatusCodeValue());
    }
    ...
    public void unSuccessfullyRetrieveAvailabilityWindow() {
        assertEquals(500, productController.getAvailability(37).getStatusCodeValue());
    }
