...
public class RentalControllerTest {
    ...
    private final Rental TEST_RENTAL_INVALID = new Rental(1, null, null, true, 1, 2);
    ...
    @Test
    @Order(2)
    public void unSuccessfullyRegisteredNewRentalDueToUnavailableDate() {
    ...
    public void unSuccessfullyRegisteredNewRental() {
        assertEquals(500, rentalController.registerNewRental(TEST_RENTAL_INVALID).getStatusCodeValue());
    }
    ...
    public void successfullyRetrievedAcceptedRentalsByUserWhenEmpty() {
        assertNull(rentalController.getAcceptedRentalsByUser(1).getBody());
    }
    ...
    @Test
    @Order(9)
    public void successfullyRetrievedNonAcceptedRentalsByProductId() {
        List<Rental> list = Arrays.asList(TEST_RENTAL);
        assertEquals(list.toString(), rentalController.getAcceptedRentals(1, false).getBody().toString());
    }
    ...
    @Test
    @Order(11)
    public void unSuccessfullyAcceptedRentalDueToDateConflict() {
    ...
    public void unSuccessfullyAcceptedRental() {
        assertEquals(500, rentalController.acceptRental(12).getStatusCodeValue());
    }
