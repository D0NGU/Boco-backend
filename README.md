...
```
cd existing_repo
git remote add origin https://gitlab.stud.idi.ntnu.no/idatt2106_2022_08/backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.stud.idi.ntnu.no/idatt2106_2022_08/backend/-/settings/integrations)
